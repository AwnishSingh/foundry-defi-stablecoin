...
contract DSCEngineTest is Test {
    ...
    function testCanRedeemCollateralSuccessfully() public depositedCollateral {
        uint256 initialCollateral = ERC20Mock(weth).balanceOf(USER);
        ...
        uint256 finalCollateral = ERC20Mock(weth).balanceOf(USER);
        assertEq(finalCollateral, initialCollateral + redeemAmount);
    }
    ...
    function testRevertsIfMintAmountBreaksHealthFactor() public depositedCollateral {
        ...
        vm.startPrank(USER);
        uint256 expectedHealthFactor = dsce.getHealthFactor(amountToMint, dsce.getUsdValue(weth, AMOUNT_COLLATERAL));
